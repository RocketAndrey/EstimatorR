...
namespace Estimator.Migrations
{
    ...
    [Migration("20200123220607_CorrectTestChains")]
    partial class CorrectTestChains
    {
            ...
            modelBuilder.Entity("Estimator.Models.TestAction", b =>
                {
                    ...
                    b.Property<int>("TestChainItemElementTypeID")
                        .HasColumnType("int");

                    b.Property<int>("TestChainItemOperationID")
                        .HasColumnType("int");

                    b.HasKey("QualificationID", "TestChainItemID");

                    b.HasIndex("TestChainItemElementTypeID", "TestChainItemOperationID");
            ...
            modelBuilder.Entity("Estimator.Models.TestChainItem", b =>
                {
                    ...
                    b.HasKey("ElementTypeID", "OperationID");
            ...
            modelBuilder.Entity("Estimator.Models.TestAction", b =>
                {
                    ...
                    b.HasOne("Estimator.Models.TestChainItem", "TestChainItem")
                        .WithMany()
                        .HasForeignKey("TestChainItemElementTypeID", "TestChainItemOperationID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
